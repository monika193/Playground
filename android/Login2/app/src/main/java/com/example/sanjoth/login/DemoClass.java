...
//        implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        number=findViewById(R.id.textView26);
        status=findViewById(R.id.textView27);
        description=findViewById(R.id.textView28);
        imageView=findViewById(R.id.imageView6);
        Bundle requestBundle = getIntent().getBundleExtra("request");
        String requestNumber = requestBundle.getString("RequestNumber");
        number.setText(requestNumber);
        ...
        description.setText(requestDescription);
...
//        getMenuInflater().inflate(R.menu.demo_class, menu);
//        return true;
//    }
//
//    @Override
